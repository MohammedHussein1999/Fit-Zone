    ...
    providers: [
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth$2f$core$2f$providers$2f$credentials$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"])({
            authorize: async (credentials)=>{
                ...
                if (userData?.length === 0) throw new Error(JSON.stringify({
                    errors: user.errors || "User not existes",
                    status: false
                }));
                return {
                    user: "ramez ahmed",
...
const $$RSC_SERVER_ACTION_0 = async function formAction(data) {
    try {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$auth$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["signIn"])("credentials", {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__ce4f96._.js.map