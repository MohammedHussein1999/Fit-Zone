...
"[project]/src/app/api/auth/me.js [app-rsc] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function handler(req, res) {
    ...
    const { token } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$cookie$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["parse"])(req.headers.cookie || "");
    if (!token) {
    ...
    try {
        const decoded = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jsonwebtoken$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].verify(token, process.env.JWT_SECRET);
        const users = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].get(`http://localhost:3001/users?id=${decoded.userId}`);
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__de29b8._.js.map