...
var __TURBOPACK__imported__module__$5b$project$5d2f$auth$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/auth.js [app-rsc] (ecmascript)");
;
;
;
;
...
const $$RSC_SERVER_ACTION_0 = async function formAction(data) {
    ...
    const request = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$auth$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["signIn"])("credentials", data);
    console.log(request);
};
