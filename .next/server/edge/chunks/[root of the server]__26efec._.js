...
function middleware(request) {
    ...
    if (protectedRoutes.some((route)=>request.nextUrl.pathname.startsWith(route))) {
        ...
        try {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jsonwebtoken$2f$index$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["default"].verify(token, process.env.JWT_SECRET);
